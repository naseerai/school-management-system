  ...
  return (
    <div className="receipt-container">
      <header className="text-center mb-4">
        ...
        <h2 className="text-lg font-semibold">Fee Receipt / Payment Statement</h2>
      </header>
        ...
        <table className="w-full text-sm border-collapse border border-slate-400">
          <thead>
            <tr>
              ...
              <th className="border border-slate-300 p-1 text-right">Amount (INR)</th>
            </tr>
          </thead>
          <tbody>
            {payments.length > 0 ? (
              ...
              <tr>
                <td colSpan={3} className="border border-slate-300 p-1 text-center">No payments recorded.</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      <footer className="mt-4 pt-2 border-t text-sm">
        <div className="text-right mb-8">
          <p className="font-bold">Total Paid: {totalPaid.toFixed(2)}</p>
        </div>
